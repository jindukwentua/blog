export const metadata = {
  ...
  category: "data",
  code_url:
    "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/recommend_duckdb.mdx",
};
...
An [earlier post](/recommend_sql/) explains why I favour SQL over other APIs such as [Polars](https://pola.rs/), [pandas](https://pandas.pydata.org/) or [dplyr](https://dplyr.tidyverse.org/).
