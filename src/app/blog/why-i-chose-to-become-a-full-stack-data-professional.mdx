export const metadata = {
  ...
  date: "2026-03-04",
  summary:
    "Why I’ve leaned into being a full-stack data scientist across analysis, engineering, and ML—and how understanding the whole lifecycle of data has shaped my career.",
};
