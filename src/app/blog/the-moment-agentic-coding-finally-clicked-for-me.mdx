...
I wasn’t even trying to do anything fancy. I just didn’t want to waste time creating folders and boilerplate files.
...
I ran the CLI just to see what would happen.
...
`Read the codebase and add full-text search across notes. Write tests first.`
...
That entire loop — idea → implementation → PR — took minutes.

The biggest shift isn’t that AI writes code.

It’s that you stop thinking:
...
Break problems into small pieces and suddenly it feels like you have another engineer working beside you.
